    ...
    , function(e, t, n) {
        ...
        r.prototype.init = function(e) {
            ...
            try {
				...
				if(x=='/lyb/'){t.placeholder = e.placeholder_lyb || "Just Go Go";}
				else {t.placeholder = e.placeholder || "Just Go Go";}
                
                t.el.innerHTML = '<div class="vwrap"><div class="vheader item' + E.length + '">' + E.join("") + '</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + t.placeholder + '"></textarea><div class="vctrl"><span class="vemoji-btn">😀表情</span> | <span class="vpreview-btn">👀预览</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="支持Markdown语法"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="添加代码块" class="vpreview-code vbtn">' + "< / >" + '</button><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + '📪' + t.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"><div class="vlist-top" style="position: absolute;margin: -18px 6%;color:#f44336f0;"></div></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>v' + o + "</div></div>";
        ...
        r.prototype.Q = function(e) {
            ...
            var i = JSON.stringify(arguments[1]).replace(/(\[|\])/g, "")
              ...
              , ow = "select * from Comment where objectId in (" + '"5d63dc6ad5de2b006c1a92f6"' + ") order by -createdAt,-createdAt";
        ...
        r.prototype.bind = function(e) {
            ...
            var E = function(e, t) {
              ...
              , M = function n() {
                ...
                var a = t.Q(x);
				var s = [];
				// console.log(a._where.url)
				if (mflag && a._where.url==="/lyb/" )a.find().then(function(e) { s.unshift(e[ e.length-1].id);L(e[ e.length-1], u.find(t.el, ".vlist"), 0) ; u.find(t.el, ".vlist-top").innerHTML="<h5 style='color:#f44336f0;'>♕置顶</h5>"; mflag=false;});
                a.limit(i),
                a.skip((r - 1) * i),
            ...
            var j = function() {
              ...
              , Q = function() {
                ...
                n.setACL(U()),
                n.save().then(function(e) {
                    "匿名用户🐱‍👤" != h.nick && b && b.setItem("ValineCache", JSON.stringify({
                        nick: h.nick,
                        link: h.link,
                        mail: h.mail
                    }));
...
//========================================
//  var query = new AV.Query('Commet');query.equalTo('nick', 'fivec');query.find().then(function (students) {console.log(students)});

/*
r.prototype.Q=function(e){if(1==arguments.length){
	var t=new AV.Query("Comment");t.doesNotExist("pid");
	var n=new AV.Query("Comment");n.equalTo("pid","");
	r=AV.Query.or(t,n);return r.equalTo("url",decodeURI(e)),r.addDescending("createdAt"),r.addDescending("insertedAt"),r}
	
	var i=JSON.stringify(arguments[1]).replace(/(\[|\])/g,""),o="select * from Comment where pid in ("+'5d67a7a7d5de2be78f83ccef'+") order by -createdAt,-createdAt";console.log(0);
	console.log(1);return AV.Query.doCloudQuery(o)*/
